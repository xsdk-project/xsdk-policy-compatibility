...
|**R8.** Each xSDK member package should have sufficient documentation to support use and further development.  |Full| [Online docs](https://bitbucket.org/icl/lapackpp/src/master/README.md#markdown-header-documentation). |
