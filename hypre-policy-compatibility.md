...
|**M5.** Provide a documented, reliable way to contact the development team. |Full| The *hypre* team can be contacted via email: hypre-support@llnl.gov or issues can be left at https:www.github.com/LLNL/hypre . |
...
| Policy                 |Support| Notes                   |
|------------------------|-------|-------------------------|
|**R1.** Have a public repository. |Partial| The development repository is private, but releases, including test releases as needed, are mirrored on github. |
